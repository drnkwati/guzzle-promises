...
use GuzzleHttp\Generators\ArrayGenerator;
...
class CoroutineTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $promisor = function () {
            return \GuzzleHttp\Promise\coroutine(new CoroutineTestGenerator1());
        };
    ...
    public function testWaitShouldHandleIntermediateErrors()
    {
        ...
        $promise = \GuzzleHttp\Promise\coroutine(new CoroutineTestGenerator1())
            ->then(function () {
                return \GuzzleHttp\Promise\coroutine(new CoroutineTestGenerator2());
            })
